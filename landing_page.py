...
# --- Robust asset paths (works locally + Render/Linux) ---
BASE_DIR = Path(__file__).resolve().parent
SHIELD_PATH = BASE_DIR / "assets" / "shield.png"
...
def landing_page():
    ...
    shield_base64 = get_image_base64(SHIELD_PATH)
...
.feature-description { color: #555; line-height: 1.5; }
...
.step-description { color: #555; line-height: 1.6; }
...
.testimonial-section { margin: 3rem 0; text-align: center; }
...
.testimonial-author { font-weight: bold; color: #2E8B57; }
</style>
        """,
...
<div class="hero-section">
    ...
    <p class="hero-description">
        <strong>AI-powered educational tool</strong> that teaches you how to exercise your FCRA rights and dispute credit report errors yourself.
...
<div class="educational-disclaimer">
    ...
    <p style="margin: 0; color: #856404;">
        Credit CPR is an <strong>educational software platform</strong> that teaches you how to identify errors on your credit report
        and exercise your rights under the Fair Credit Reporting Act (FCRA). You dispute errors yourself — we guide you through it.
    </p>
</div>
        """,
        unsafe_allow_html=True,
...
<div class="testimonial-card">
    ...
    # ---------------------------------------------------------------------
    # ✅ FIXED SECTION 1: How It Works (dedented so it never renders as code)
    # ---------------------------------------------------------------------
    st.markdown(
        textwrap.dedent(
            """
<div class="process-section">
    ...
    # ---------------------------------------------------------------------
    # ✅ FIXED SECTION 2: What You'll Learn (dedented) + removed “Completely Free”
    # ---------------------------------------------------------------------
    st.markdown(
...
<div class="feature-grid">
    ...
    # --- FAQ Section ---
    st.markdown(
        "<h2 style='text-align: center; color: #1B3A5C; margin: 3rem 0 2rem;'>Frequently Asked Questions</h2>",
        unsafe_allow_html=True,
    )

    with st.expander("❓ What do I get with a subscription?"):
        st.write(
            """
Credit CPR provides AI-powered education, report analysis guidance, and professional dispute-letter drafting tools.
You remain in control: you review, customize, and send disputes yourself. Plans may vary based on usage and features.
            """
        )
...
your credit for you — we teach you how to do it yourself, which is your legal right under the FCRA.
            """
        )
...
privacy seriously. Once you close your browser, your data is gone.
    ...
    with st.expander("❓ Will this actually improve my credit score?"):
        st.write(
            """
**It can!** If your credit report contains errors, successfully disputing them can improve your score.
However, we’re an educational tool — results depend on whether errors exist on your report and how bureaus respond.
            """
        )
...
about follow-up strategies, including filing complaints with the CFPB and understanding your right to sue under FCRA.
            """
        )
...
<div class="hero-section" style="padding: 3rem 2rem;">
    ...
    <p style="font-size: 1.2rem; margin-bottom: 2rem;">
        Start learning how to identify and dispute credit report errors today — in minutes.
    </p>
</div>
        """,
        unsafe_allow_html=True,
